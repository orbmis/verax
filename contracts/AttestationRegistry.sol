...
contract AttestationRegistry is OwnableUpgradeable {
  ...
  bytes32 public currentAttestationId;
  ...
  function attest(AttestationPayload memory attestationPayload) external onlyPortals(msg.sender) {
    ...
    attestation.schemaId = attestationPayload.schemaId;
    attestation.subject = attestationPayload.subject;
    attestation.expirationDate = attestationPayload.expirationDate;
    ...
    attestation.attestationId = bytes32(attestationCount + 1);
